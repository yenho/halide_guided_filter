...
android_gf: gf.cpp aot_ndk_arm64/guided_filter.a aot_ndk_arm64/guided_filter.h
	$(NDK_CXX) $(CXX_FLAGS) -D__ANDROID__ -I aot_ndk_arm64 -o android_gf gf.cpp aot_ndk_arm64/guided_filter.a  $(NDK_CXX_GF_LIBS)
...
aot_ndk_arm64/guided_filter.a: gf_generator
	LD_LIBRARY_PATH=../bin/ ./gf_generator -g guided_filter -o ./aot_ndk_arm64 auto_schedule=false target=arm-64-android-hvx_128
...
clean_aot:
	rm -f aot/* aot_ndk_arm64/* aot_ndk_arm32/*

clean:
	rm -f divmap_gen gf_jit gf android_gf gf_generator 
