#ifndef HALIDE_____android___aot___guided_filter_h
#define HALIDE_____android___aot___guided_filter_h
#include <stdint.h>
...
int guided_filter(struct halide_buffer_t *_input_I_buffer, struct halide_buffer_t *_input_P_buffer, int32_t _radius, float _eps, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int guided_filter_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *guided_filter_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return guided_filter_metadata;
}
#endif


int guided_filter_old_buffer_t(struct buffer_t *_input_I, struct buffer_t *_input_P, int32_t _radius, float _eps, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
