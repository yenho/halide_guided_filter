#ifndef HALIDE_____android___aot___fast_guided_filter_h
#define HALIDE_____android___aot___fast_guided_filter_h
#include <stdint.h>
...
int fast_guided_filter(struct halide_buffer_t *_input_I_buffer, struct halide_buffer_t *_input_P_buffer, int32_t _radius, int32_t _down, float _eps, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int fast_guided_filter_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *fast_guided_filter_metadata() HALIDE_FUNCTION_ATTRS;
...
inline int (*HALIDE_GET_STANDARD_ARGV_FUNCTION())(void**) {
    return fast_guided_filter_argv;
}
#endif
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return fast_guided_filter_metadata;
}
#endif


int fast_guided_filter_old_buffer_t(struct buffer_t *_input_I, struct buffer_t *_input_P, int32_t _radius, int32_t _down, float _eps, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
