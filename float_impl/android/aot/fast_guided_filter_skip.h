#ifndef HALIDE_____android___aot___fast_guided_filter_skip_h
#define HALIDE_____android___aot___fast_guided_filter_skip_h
#include <stdint.h>
...
int fast_guided_filter_skip(struct halide_buffer_t *_input_I_buffer, struct halide_buffer_t *_input_P_buffer, int32_t _radius, int32_t _down, float _eps, struct halide_buffer_t *_output_buffer, struct halide_buffer_t *_mean_a_buffer, struct halide_buffer_t *_mean_b_buffer) HALIDE_FUNCTION_ATTRS;
int fast_guided_filter_skip_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *fast_guided_filter_skip_metadata() HALIDE_FUNCTION_ATTRS;
...
inline int (*HALIDE_GET_STANDARD_ARGV_FUNCTION())(void**) {
    return fast_guided_filter_skip_argv;
}
#endif
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return fast_guided_filter_skip_metadata;
}
#endif


int fast_guided_filter_skip_old_buffer_t(struct buffer_t *_input_I, struct buffer_t *_input_P, int32_t _radius, int32_t _down, float _eps, struct buffer_t *_output, struct buffer_t *_mean_a, struct buffer_t *_mean_b) HALIDE_FUNCTION_ATTRS;
