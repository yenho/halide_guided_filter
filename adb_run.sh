...
# divmap.bin is generated by divmap_gen
adb push divmap.bin /data/local/tmp
adb push android_gf /data/local/tmp
adb shell "cd /data/local/tmp; LD_LIBRARY_PATH=./ ./android_gf cat.gray divmap.bin 3840 2160 11 800 out.gray"
